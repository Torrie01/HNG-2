          ...
          <div className='movies-info'>
            <div className='left-sidebar'>
              ...
              <div className='sidebar-links'>
                <a href='/'><img src={PixA} alt='will'/><span>Home</span></a>
                <a href='/'><img src={PixB} alt='will'/><span>Movies</span></a>
                <a href='/'><img src={PixC} alt='will'/><span>TV series</span></a>
                <a href='/'><img src={PixD} alt='will'/><span>Upcoming</span></a>
              </div>
              <div className='ads'>
                <p>Play movie quizes and earn free tickets</p>
                <span>For people are playing now</span>
                <a href='/' className='play-btn'>start playing</a>
              </div>
              <a className='log-off' href='https'><img src={PixF} alt='yell'/> <span>Log out</span></a>
            </div>
